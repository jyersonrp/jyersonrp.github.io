          ...
          <div className="lg:col-span-6 flex flex-col gap-8">
            ...
            <div className="space-y-4">
              ...
              {EXPERIENCE_ITEMS.map((item, idx) => (
                <div
                  key={idx}
                  className="glass-panel-card border border-white/[0.08] backdrop-blur-xl hover:border-emeraldNeon/40 transition-all duration-300 p-6 sm:p-8 rounded-3xl relative overflow-hidden group shadow-[0_12px_35px_-12px_rgba(0,0,0,0.5)]"
                >
          ...
          <div className="lg:col-span-6 flex flex-col gap-8">
            ...
            <div className="space-y-4">
              ...
              {EDUCATION_ITEMS.map((edu, idx) => (
                <div
                  key={idx}
                  className="glass-panel-card group relative rounded-3xl p-6 sm:p-8 transition-all duration-500 overflow-hidden border border-white/[0.1] hover:border-cyanNeon/50 backdrop-blur-2xl shadow-[0_15px_35px_-10px_rgba(0,0,0,0.5)] hover:shadow-[0_20px_50px_-10px_var(--accent-glow-secondary)]"
                >
                  ...
                  <div className="relative z-10 mb-4">
                    <h4 className="text-lg sm:text-xl font-sans font-bold text-white tracking-tight group-hover:text-cyanNeon transition-colors duration-300">
                      {edu.degree[language]}
                    </h4>
                  ...
                  <div className="relative z-10 my-4 p-4 rounded-2xl bg-gradient-to-r from-cyanNeon/[0.12] via-emeraldNeon/[0.1] to-white/[0.02] border border-cyanNeon/35 shadow-[0_0_25px_var(--accent-glow-secondary)]">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {CERTIFICATIONS.map((cert, idx) => {
                  ...
                  return (
                    <div
                      key={idx}
                      className="glass-panel-card group relative rounded-3xl p-5 sm:p-6 transition-all duration-500 overflow-hidden border border-white/[0.1] hover:border-emeraldNeon/50 backdrop-blur-2xl shadow-[0_12px_30px_-10px_rgba(0,0,0,0.5)] hover:shadow-[0_20px_45px_-10px_var(--accent-glow)] flex flex-col justify-between"
                    >
                      ...
                      <div>
                        ...
                        {/* Title */}
                        <h5 className="relative z-10 font-sans font-bold text-sm sm:text-base text-white tracking-tight group-hover:text-emeraldNeon transition-colors duration-200 mb-2 leading-snug">
                          {cert.name[language]}
                        </h5>
                      ...
                      <div className="relative z-10 flex flex-wrap gap-1.5 pt-2 border-t border-white/[0.05]">
                        {cert.skills.map((s, sIdx) => {
                          ...
                          return (
                            <span
                              key={sIdx}
                              className="inline-flex items-center gap-1 px-2 py-0.5 rounded-lg text-[9px] font-mono bg-white/[0.04] text-neutral-300 border border-white/[0.07] group-hover:border-emeraldNeon/25 transition-colors"
                            >
